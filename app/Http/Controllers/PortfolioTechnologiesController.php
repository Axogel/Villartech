...
use App\Technology;
use App\PortfolioTechnology;

class PortfolioTechnologiesController extends \TCG\Voyager\Http\Controllers\Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'Technology'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $view = 'voyager.portfolio-technologies.edit-add';
    ...
    public function searchChildrenTechnologies($id)
    {
        $searchChildren = Technology::
                      where('parent_id', $id)  
                      ->get();
        return response()->json($searchChildren);
    }
    ...
    public function store(Request $request)
    {
        ...
        $data2 = PortfolioTechnology::find($data->id);
        $data2->technology_id = $request['children'][0];
        $data2->save();
        $total = count($request['children']);
        //dd($total);
        if($total > 1){
            for ($i=1; $i <$total ; $i++) { 
                $data3 = new PortfolioTechnology;
                $data3->portfolio_id = $data->portfolio_id;
                $data3->technology_id = $request['children'][$i];
                $data3->save();
            }
        }
