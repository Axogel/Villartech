                                 ...
                                 <div class="collapse navbar-collapse" id="navbarModalTeam">
                                   ...
                                   <li class="nav-item col-12">
                                      ...
                                      <div class="pt-4">
                                        ...
                                        <a class="fs-6 text-center"style="font-family: 'Lato'; font-weight: 300; color:white;" href="#tab_experience_{{  $teamId }}" data-toggle="tab">
                                            EXPERIENCE
                                        </a>
                                    </div>
                                      </li>
                                      ...
                                      <div class="pt-4" href="#tab_education_{{ $teamId }}" data-toggle="tab">
                                        ...
                                        <a class="fs-6 text-center"style="font-family: 'Lato'; font-weight: 300; color:white;" href="#tab_education_{{  $teamId }}" data-toggle="tab">
                                            EDUCATION
                                        </a>
                                    </div>
                                      </li>
                                      ...
                                      <div class="pt-4" href="#tab_overview_{{ $teamId }}" data-toggle="tab">
                                        ...
                                        <a class="fs-6 text-center"style="font-family: 'Lato'; font-weight: 300; color:white;" href="#tab_overview_{{ $teamId }}" data-toggle="tab">
                                            OVERVIEW
                                        </a>
                                    </div>
                                      </li>
