...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="assets/img/villartechlogo.png">
  </head>
  <body>
    <!-- Navbar Menu  ---->
    <section id="nav-bar">
      <nav class="navbar navbar-expand-lg navbar-light">
         <a class="navbar-brand" href="#">
           <img src="assets/img/villartechlogo.png" alt="" width="130" height="180">
         </a>
    ...
    <section class="banner">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <p class="promo-title">Villartechnologies</p>
            <p class="join-title">Custom Software Development</p>
          </div>
            <div class="col-md-6">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 footer-box">
              <img src="images/webiz-logo.png" alt="">
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
              </p>
    ...
    <!--- Smooth Scroll js ---------->
    <script src="{{ asset('assets/js/smooth-scroll.js') }}" type="text/javascript"></script>
    <script>
