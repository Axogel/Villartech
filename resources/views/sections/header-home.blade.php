            ...
            <ul class="navbar-nav mb-2 mb-lg-0 w-100"  id="navbar-villar" style="padding-left: 50px;">
              ...
              <li class="nav-item px-2 w-100">
                <div id="contact-us-navbar">
                  <a class="nav-link active text-light bold-size margin-contactUs" aria-current="page" href="#contact" style="font-size: 14px; text-align: center; background-color: #045197; border-radius: 8px; width: 100px ">
                    CONTACT US
                  </a>
                </div>
              </li>
