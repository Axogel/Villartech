                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1 col-md-1 col-lg-1" style="background-color:#045A97;" id="navbarNavAltMarkup">
                                <div class="text-center" style="list-style:none;">
                                    ...
                                    <hr style="height:3px;border:none;color:white;background-color:white; width:76px;" class="margin-hr-responsive d-block">
                                    ...
                                    <hr style="height:3px;border:none; color:white;background-color:white;" class="margin-hr-responsive d-block w-100">
                            ...
                            <div class="col-sm-6  col-md-6 col-lg-6">
                                <div class="tab-content">
                                    <div class="tab-pane active animated fadeInRight" id="tab_about_{{ $team->id }}">
                                        ...
                                        <div class="col-11 height-responsive-modal" style="background-color: #045A97;">
                                            <div class="row">
