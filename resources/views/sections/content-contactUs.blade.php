  ...
  <div class="row justify-content-center align-items-center">
    ...
    <div class="col-md-3">
      <div class="text-contactUs text-left my-5">
        ...
        <br>
        <br>
        <p>We would love to hear from you! If you have any questions, inquiries, or project ideas, please reach out to us using the contact information below or by filling out the contact form. Our dedicated team is ready to assist you.</p>
      </div>
    </div>
...
<section class="section-form-contactUs" style="background-color:#FFFFF">
          ...
          <div class="col-8 mx-auto col" style="background-color: #FFFFF;" id="contact-form">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        ...
                        <div class="col-12 py-4">
                          <button type="submit" class="btn btn-primary solid blank" style="padding:6px 8px 6px 8px; width:134px">JUST SEND</button>
                        </div>
                          </div>
                        </div>
                      </div>
