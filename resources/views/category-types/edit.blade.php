        ...
        <div class="row">
            ...
            <div class="col-xl-8 mb-5 mb-xl-0">
                <div class="col mt-5" style="display:grid; padding-top:80px; width:80%;">
                    {!! Form::open([
                        'route' => ['category-types.update', ['category_type' => $categoryType->id]],
                        'method' => 'PUT',
                        'files' => true,
                    ]) !!}
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            ...
                            {!! Form::text('name', old('name', $categoryType->name), [
                            'id' => 'name',
                    ...
                    <div style="text-align:center; margin-top:50px; margin-left:1px;" class="row mb-6">
                        <a href="{{ route('category-types.index') }}" class="btn btn-light me-2">Back</a>
