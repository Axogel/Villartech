    ...
    <div class="container-fluid mt--12">
        <div class="row">
            ...
            <div class="col-xl-12 mb-5 mb-xl-0">
                ...
                <p class="pt-5" style="font-size:25px; color:#045A97; font-weight:900;">Portfolios <span> <a href="{{ route('portfolios.create') }}" class="btn btn-success" style="float:right;">Create
                    portfolio</a></span></p>
